...
// it takes for the scanner to start tracking this tag. Set it accordingly.
    BT_LE_ADV_PARAM_INIT(BT_LE_ADV_OPT_EXT_ADV |
                         BT_LE_ADV_OPT_USE_NAME | BT_LE_ADV_OPT_NO_2M | BT_LE_ADV_OPT_USE_IDENTITY,
...
void btAdvSetReservedEddystoneData(uint8_t rfu1, uint8_t rfu2)
{
    *((uint8_t *)&ad[2].data[ADV_DATA_OFFSET_RFU]) = rfu1;
    *((uint8_t *)&ad[2].data[ADV_DATA_OFFSET_RFU + 1]) = rfu2;

    LOG_INF("Set ext adv data with RFU bytes changed...");
