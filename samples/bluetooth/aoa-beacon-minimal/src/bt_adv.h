...
/**
 * @brief Set the reserved Eddystone data.
 *
 * Allows setting the RFU1 and RFU2 bytes in the Eddystone data for payload
 * transmission to locator.
 * @param rfu1      RFU1 byte.
 * @param rfu2      RFU2 byte.
 *
 */
